...
Total changes: **273** (129 changed, 144 new vs. vanilla)
...
- [GardeningWeapon](#gardeningweapon) (4)
...
+ Base.MacheteForged     Machete      0.80 -> 0.50  (-37.5%)
+ Base.Machete           Machete      0.80 -> 0.50  (-37.5%)
```
...
+ Base.LargeKnifeBlade              Large Knife Blade                  0.25 -> 0.20  (-20.0%)
- Base.MacheteBlade_NoTang          Machete Blade (No Tang)            0.30 -> 0.35  (+16.7%)
+ Base.MacheteBlade                 Machete Blade                      0.35 -> 0.30  (-14.3%)
